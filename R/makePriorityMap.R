...
#' @param version                Default is \code{"2"}. Version "1" uses slope as a proxy to marine birds' nests. Version
#'                               "2" has the marine bird nests data.
#' @param bufferNests            Default is set to 400. This is the distance in meters from the nests (used if version = "2")
...
if (version != "2"){
  ...
  priorityArea <-  catSecRas * ninhaisRas
}
  # GIS manipulation
  ...
  priorityAreaCropped <- postProcess(x = focRas, studyArea = parnamar,
                                     filename2 = NULL,
                                     format = "GTiff",
                                     overwrite = TRUE)
